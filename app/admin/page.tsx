      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 py-6 sm:py-8">
        <div className="flex flex-col lg:flex-row lg:items-end lg:justify-between gap-4 mb-6">
          <div>
            ...
            <p className="text-sm text-on-surface-variant mt-1">Organization-level overview. Use People for the complete office directory and Team for progress management.</p>
          </div>
        ...
        <section className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 mb-6">
          <AdminStatCard label="Total Members" value={totalMembers} active={activeMembers} />
          <AdminStatCard label="Total Admins" value={totalAdmins} active={activeAdmins} />
          <AdminStatCard label="Total Managers" value={totalManagers} active={activeManagers} />
          <AdminStatCard label="Total Employees" value={totalEmployees} active={activeEmployees} />
        </section>
        ...
        <section className="bg-surface-container-lowest border border-outline-variant rounded-xl p-5 mt-6">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-3">
            ...
            <AdminLink href="/employees" title="People" description={`View all ${totalMembers} office members: ${totalEmployees} employees, ${totalManagers} managers and ${totalAdmins} admins.`} />
