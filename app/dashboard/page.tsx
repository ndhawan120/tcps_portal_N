...
export default async function DashboardPage() {
  ...
  if (!isAdmin && !isManager) {
    ...
    </div></main><Link href="/exams" aria-label="New Exam Entry" className="fixed bottom-6 right-6 z-40 w-14 h-14 rounded-full bg-primary text-white shadow-lg flex items-center justify-center text-3xl hover:scale-105 active:scale-95 transition-transform">+</Link></div>;
  }
