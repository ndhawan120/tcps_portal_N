...
export default function Nav({ role, name }: { role: string; name: string }) {
  ...
  const links = useMemo<NavLink[]>(() => {
    ...
    if (role === "admin") return [...base, { href: "/employees", label: "People", icon: "groups" }, { href: "/approvals", label: "Approvals", icon: "fact_check" }, { href: "/reports", label: "Reports", icon: "assessment" }, { href: "/admin", label: "Admin", icon: "admin_panel_settings" }, { href: "/admin/roles", label: "Roles & Access", icon: "manage_accounts" }, { href: "/announcements", label: "Updates", icon: "campaign" }, { href: "/profile", label: "Profile", icon: "person" }];
    if (role === "manager") return [...base, { href: "/manager", label: "Team", icon: "groups" }, { href: "/approvals", label: "Approvals", icon: "fact_check" }, { href: "/reports", label: "Reports", icon: "assessment" }, { href: "/announcements", label: "Updates", icon: "campaign" }, { href: "/profile", label: "Profile", icon: "person" }];
    return [...base, { href: "/documents", label: "Documents", icon: "description" }, { href: "/announcements", label: "Updates", icon: "campaign" }, { href: "/profile", label: "Profile", icon: "person" }];
  }, [role]);
